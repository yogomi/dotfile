...
if [ -d ~/.claude/docs ]; then rm -rf ~/.claude/docs; fi
ln -sfn ${PWD}/claude/docs ~/.claude/docs
if [ -d ~/.claude-work/docs ]; then rm -rf ~/.claude-work/docs; fi
ln -sfn ${PWD}/claude/docs ~/.claude-work/docs
